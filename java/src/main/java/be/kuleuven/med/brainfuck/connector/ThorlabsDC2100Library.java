...
/**
 * JNA Wrapper for library <b>thorlabs-dc2100-nativelib</b><br>
...
public class ThorlabsDC2100Library implements StdCallLibrary {
	...
	public static final int HEAD_WITHOUT_EEPROM = 255;
	public static final int STAT_NO_LED1_CHANGED = 0x0010;
	public static final int _VI_ERROR = -2147483647 - 1;
	public static final int VI_INSTR_ERROR_OFFSET = (-2147483647 - 1) + 0x3FFC0900;
	public static final int VI_NULL = 0;
	public static final int STAT_LED_LIMIT1 = 0x0200;

	public static final int STAT_OTP = 0x0008;
	public static final int STAT_OTP_CHANGED = 0x0004;
	public static final int DC2100_ERR_DESCR_BUFFER_SIZE = 512;
	public static final int MODUS_CONST_CURRENT = 0;
	public static final int STAT_VCC_FAIL_CHANGED = 0x0001;
	 ...
	 */
	public static native int DC2100_setLimitCurrent(NativeLong instrumentHandle, float limit);
	/**
	 ...
	 */
	public static native int DC2100_setMaxLimit(NativeLong instrumentHandle, float limit);
	/**
	 ...
	 */
	public static native int DC2100_setOperationMode(NativeLong instrumentHandle, NativeLong operationMode);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_getOperationMode(ViSession, ViPInt32)</code><br>
	 * <i>native declaration : line 127</i>
	 */
	public static native int DC2100_getOperationMode(NativeLong instrumentHandle, NativeLongByReference operationMode);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_setLedOnOff(ViSession, ViBoolean)</code><br>
	 * <i>native declaration : line 132</i>
	 */
	public static native int DC2100_setLedOnOff(NativeLong instrumentHandle, int ledOnOff);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_getLedOnOff(ViSession, ViPBoolean)</code><br>
	 * <i>native declaration : line 133</i>
	 */
	public static native int DC2100_getLedOnOff(NativeLong instrumentHandle, ShortByReference ledOnOff);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_setConstCurrent(ViSession, ViReal32)</code><br>
	 * <i>native declaration : line 138</i>
	 */
	public static native int DC2100_setConstCurrent(NativeLong instrumentHandle, float current);
	/**
	 ...
	 */
	public static native int DC2100_setPWMCurrent(NativeLong instrumentHandle, float current);
	/**
	 ...
	 */
	public static native int DC2100_setPWMFrequency(NativeLong instrumentHandle, NativeLong frequency);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_getPWMFrequency(ViSession, ViPInt32)</code><br>
	 * <i>native declaration : line 151</i>
	 */
	public static native int DC2100_getPWMFrequency(NativeLong instrumentHandle, NativeLongByReference frequency);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_setPWMDutyCycle(ViSession, ViInt32)</code><br>
	 * <i>native declaration : line 156</i>
	 */
	public static native int DC2100_setPWMDutyCycle(NativeLong instrumentHandle, NativeLong dutyCycle);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_getPWMDutyCycle(ViSession, ViPInt32)</code><br>
	 * <i>native declaration : line 157</i>
	 */
	public static native int DC2100_getPWMDutyCycle(NativeLong instrumentHandle, NativeLongByReference dutyCycle);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_setPWMCounts(ViSession, ViInt32)</code><br>
	 * <i>native declaration : line 162</i>
	 */
	public static native int DC2100_setPWMCounts(NativeLong instrumentHandle, NativeLong counts);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_getPWMCounts(ViSession, ViPInt32)</code><br>
	 * <i>native declaration : line 163</i>
	 */
	public static native int DC2100_getPWMCounts(NativeLong instrumentHandle, NativeLongByReference counts);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_setDispBright(ViSession, ViInt32)</code><br>
	 * <i>native declaration : line 168</i>
	 */
	public static native int DC2100_setDispBright(NativeLong instrumentHandle, NativeLong displayBrightness);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_getDispBright(ViSession, ViPInt32)</code><br>
	 * <i>native declaration : line 169</i>
	 */
	public static native int DC2100_getDispBright(NativeLong instrumentHandle, NativeLongByReference displayBrightness);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_getStatusRegister(ViSession, ViPInt32)</code><br>
	 * <i>native declaration : line 174</i>
	 */
	public static native int DC2100_getStatusRegister(NativeLong instrumentHandle, NativeLongByReference statusRegister);
	/**
	 ...
	 */
	@Deprecated 
	public static native int DC2100_getWavelength(NativeLong instrumentHandle, FloatByReference wavelength);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_getWavelength(ViSession, ViPReal32)</code><br>
	 * <i>native declaration : line 200</i>
	 */
	public static native int DC2100_getWavelength(NativeLong instrumentHandle, FloatBuffer wavelength);
	/**
	 ...
	 */
	@Deprecated 
	public static native int DC2100_getForwardBias(NativeLong instrumentHandle, FloatByReference forwardBias);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_getForwardBias(ViSession, ViPReal32)</code><br>
	 * <i>native declaration : line 205</i>
	 */
	public static native int DC2100_getForwardBias(NativeLong instrumentHandle, FloatBuffer forwardBias);
	/**
	 * Original signature : <code>_VI_FUNC DC2100_close(ViSession)</code><br>
	 * <i>native declaration : line 210</i>
	 */
	public static native int DC2100_close(NativeLong instrumentHandle);
